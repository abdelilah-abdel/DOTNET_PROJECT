...
df = pd.DataFrame({'HotelName':namesT ,'City': cityS})

#df.to_xlsx('untitled.xlsx', columns=['HotelName','City'], index=False)

df.to_excel("Abdelilah.xlsx", index=False)
